...
export const DEMO_PLAYERS: Player[] = [
  { id:'dp1', name:'Jordan Voss',   elo:3150, eloHistory:[], wins:45, losses:12, currentStreak:3,  bestStreak:8,  gamesPlayed:57, badges:['flash-serve','hot-streak','season-vet','atp-master','court-dominator','inferno'], xp:3705, level:19, recentForm:['W','W','W','L','W'], createdAt:D, isUser:false },
  { id:'dp2', name:'Priya Mehta',   elo:2840, eloHistory:[], wins:38, losses:18, currentStreak:-1, bestStreak:6,  gamesPlayed:56, badges:['flash-serve','hot-streak','season-vet','atp-master','court-dominator','inferno'], xp:3640, level:19, recentForm:['L','W','W','W','L'], createdAt:D, isUser:false },
  { id:'dp3', name:'Kai Tanaka',    elo:2710, eloHistory:[], wins:35, losses:20, currentStreak:2,  bestStreak:5,  gamesPlayed:55, badges:['flash-serve','hot-streak','season-vet','atp-master','inferno'],                  xp:3575, level:18, recentForm:['W','W','L','W','W'], createdAt:D, isUser:false },
  { id:'dp4', name:'Bree Okonkwo',  elo:2650, eloHistory:[], wins:30, losses:15, currentStreak:3,  bestStreak:7,  gamesPlayed:45, badges:['flash-serve','hot-streak','season-vet','atp-master'],                           xp:2925, level:15, recentForm:['W','W','W','L','W'], createdAt:D, isUser:false },
  { id:'dp5', name:'Mateo Silva',   elo:2580, eloHistory:[], wins:28, losses:14, currentStreak:4,  bestStreak:4,  gamesPlayed:42, badges:['flash-serve','hot-streak','season-vet','atp-master'],                           xp:2730, level:14, recentForm:['L','W','W','W','W'], createdAt:D, isUser:false },
  ...
  { id:'dp8', name:'Coach Rivera',  elo:1945, eloHistory:[], wins:22, losses:18, currentStreak:2,  bestStreak:4,  gamesPlayed:40, badges:['flash-serve','hot-streak','season-vet'],                                        xp:2600, level:13, recentForm:['W','W','L','W','L'], createdAt:D, isUser:false },
